...
# edit
alias vimfish='nvim ~/.config/fish/config.fish'
alias vimzsh='nvim ~/.zshrc'
alias vimrc='nvim ~/.vimrc'
alias vimssh='nvim ~/.ssh/config'
alias vimstar='nvim ~/.config/starship.toml'
alias vimgit='nvim ~/.gitconfig'
alias vimtmux='nvim ~/.tmux.conf'
alias vimdein='nvim ~/.vim/rc/dein.toml'
alias vimdeinl='nvim ~/.vim/rc/lazy_dein.toml'
alias vimnavi='nvim ~/.local/share/navi/cheats/denisidoro__cheats/misc__misc.cheat'
alias vimmemo='nvim $MEMO_PATH'
alias vimhosts='nvim /etc/hosts'
